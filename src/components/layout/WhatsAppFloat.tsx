...
export function WhatsAppFloat() {
  return (
    <>
      {/* Desktop: fixed right-edge tab */}
      <a
        href={waLink()}
        target="_blank"
        rel="noreferrer"
        aria-label="Enquire now on WhatsApp"
        className="hidden md:flex fixed right-0 top-1/2 -translate-y-1/2 z-40 items-center gap-2 rounded-l-lg bg-[#0E6B3A] hover:bg-[#128C4B] px-4 py-3 text-white text-[12px] tracking-[0.18em] uppercase shadow-[0_10px_40px_-10px_rgba(0,0,0,0.6)] transition"
      >
